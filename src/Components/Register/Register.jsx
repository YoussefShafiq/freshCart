  ...
  return <>
    ...
    <div className='flex flex-wrap items-center'>
      ...
      <form onSubmit={formik.handleSubmit} className='md:w-1/2 w-full p-5 m-auto py-10'>
        <h1 className='text-3xl py-4 font-semibold'><NavLink to="/register">Register now</NavLink></h1>
      ...
      <div className='flex justify-center w-full mb-10  '>
        <div >Already have account? <span className='text-sky-500 py-4 font-semibold'><NavLink to="/login">login</NavLink></span></div>
      </div>
    </div>
